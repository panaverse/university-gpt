...
# ------------------------------------------------------
class QuestionCRUD:
    async def add_question(self, *, question: QuestionBankCreate, db: AsyncSession):
        """
    ...
    async def read_questions(self, *, db: AsyncSession, offset: int, limit: int):
        """
        ...
        try:
            result = await db.exec(select(QuestionBank).offset(offset).limit(limit))
    ...
    async def read_questions_by_type(self, *, question_type: str, db: AsyncSession):
        """
    ...
    async def get_question_by_id(self, *, id: int, db: AsyncSession):
        """
        ...
        try:
            ...
            result = await db.exec(select(QuestionBank).where(QuestionBank.id == id))
    ...
    async def update_question(
        self, *, id: int, question: QuestionBankUpdate, db: AsyncSession
    ):
        """
    ...
    async def delete_question(self, *, id: int, db: AsyncSession):
        """
...
class MCQCRUD:
    async def add_mcq_option(
        self, *, mcq_option: MCQOptionCreate, session: AsyncSession
    ):
        """
    ...
    async def read_mcq_options(self, *, db: AsyncSession, offset: int, limit: int):
        try:
    ...
    async def get_mcq_option_by_id(self, *, id: int, db: AsyncSession):
        """
    ...
    async def update_mcq_option(
        self, *, id: int, mcq_option: MCQOptionUpdate, db: AsyncSession
    ):
        """
    ...
    async def delete_mcq_option(self, *, id: int, db: AsyncSession):
        """
