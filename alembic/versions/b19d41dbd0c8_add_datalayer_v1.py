...
def upgrade() -> None:
    ...
    op.create_table(
        "university",
        sa.Column(
            "university_name", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_answersheet_quiz_id"), "answersheet", ["quiz_id"], unique=False
    )
    op.create_index(
        op.f("ix_answersheet_student_id"), "answersheet", ["student_id"], unique=False
    )
    op.create_table(
        "content",
    ...
    op.create_table(
        ...
        sa.Column(
            "question_type",
            sa.Enum(
                "single_select_mcq", "multiple_select_mcq", name="questiontypeenum"
            ),
            nullable=False,
        ),
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_quiztopic_quiz_id"), "quiztopic", ["quiz_id"], unique=False
    )
    op.create_index(
        op.f("ix_quiztopic_topic_id"), "quiztopic", ["topic_id"], unique=False
    )
    op.create_table(
        "answerslot",
    ...
    op.create_index(
        op.f("ix_answerslot_question_id"), "answerslot", ["question_id"], unique=False
    )
    op.create_index(
        op.f("ix_answerslot_quiz_answer_sheet_id"),
        "answerslot",
        ["quiz_answer_sheet_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_quizquestion_question_id"),
        "quizquestion",
        ["question_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_quizquestion_quiz_id"), "quizquestion", ["quiz_id"], unique=False
    )
    op.create_index(
        op.f("ix_quizquestion_topic_id"), "quizquestion", ["topic_id"], unique=False
    )
    op.create_table(
        "answerslotoption",
    ...
    op.create_index(
        op.f("ix_answerslotoption_id"), "answerslotoption", ["id"], unique=False
    )
