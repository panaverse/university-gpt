...
from app.core.utils.generic_models import QuestionDifficultyEnum, QuestionTypeEnum
...
class MCQOption(MCQOptionBase, table=True):
    ...
    question: "QuestionBank" = Relationship(
        back_populates='options')  # type: ignore
...
class QuestionBank(QuestionBankBase, table=True):
    ...
    # topic Relationship
    topic: 'app.quiz.topic.models.Topic' = Relationship(
    ...
    quiz_questions: list['app.quiz.quiz.models.QuizQuestion'] = Relationship(
